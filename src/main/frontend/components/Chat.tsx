...
import Attachment from "Frontend/generated/ai/patterns/web/endpoints/AiChatService/Attachment";
import Message from 'Frontend/generated/ai/patterns/web/endpoints/AiChatService/Message';
...
interface AiChatService {
  stream(chatId: string, userMessage: string, options: any): Subscription<string>;
...
export function Chat({
                       ...
                       service,
                       acceptedFiles,
                       options = {systemMessage: '', attachmentIds: []},
                       renderer,
                       className,
                     }: ChatProps) {
  ...
  function getCompletion(userMessage: string, attachments?: File[]) {
    ...
    let first = true;
    service.stream(chatId, userMessage, {...options, attachmentIds})
      .onNext((token) => {
        if (first && token) {
